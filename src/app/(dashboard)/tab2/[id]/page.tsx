        ...
        if (googleMapsLoaded && bus) {
          ...
          if (startCoords && endCoords && liveLocationCoords) {
            const mapInstance = new window.google.maps.Map(mapRef.current!, {
              center: { lat: validWaypoints[0].lat, lng: validWaypoints[0].lng },
              zoom: 10,
            });
            ...
            validWaypoints.forEach((waypoint, index) => {
              ...
              if (index === 0) {
                iconOptions = { url: "https://cdn-icons-png.flaticon.com/128/684/684908.png",
                  scaledSize: new window.google.maps.Size(22, 22),
                };

              } else if (index === validWaypoints.length - 1) {
                iconOptions = { url: "https://cdn-icons-png.flaticon.com/128/16750/16750007.png",
                  scaledSize: new window.google.maps.Size(22, 22),
                };
