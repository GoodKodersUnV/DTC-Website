      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-y-3">
        <div className="flex-grow">
          <input
            ...
            className="border bg-gray-500 border-secondary text-sm font-medium p-2.5 outline-none rounded-lg w-full"
        ...
        <button 
          type="submit"
          disabled={loading}
          className="bg-blue-600 text-secondary p-2 text-sm rounded-lg font-medium"
        >
          Sign In
        </button>
      </form>
